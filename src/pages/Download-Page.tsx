...
import "../styles/Download-Page.css"; // Import main stylesheet for the Download page
import Footer from "../components/Footer.tsx"; // Reusable footer component
...
export default function DownloadPage() {
  const { t } = useTranslation(); // Access translation function for localization
  return (
    <>
      ...
      <section className="download-hero-section">
        <div className="overlay text-center text-white d-flex flex-column justify-content-center align-items-center">
          {/* Main title */}
          <h1 className="fw-bold mb-3">{t("download.title")}</h1>
          {/* Subtitle */}
          <p className="lead mb-4">{t("download.subtitle")}</p>
          {/* External link to official Spotify download */}
          <a
      ...
      <section className="platform-section text-center py-5 bg-white text-dark">
        <h2 className="fw-bold mb-3">{t("platform.title")}</h2>
        <p className="mb-4">{t("platform.description")}</p>
        {/* App download icons for different platforms */}
      ...
      <section className="devices-banner-section d-flex flex-column justify-content-between text-white text-center">
        <div></div>
        <div className="mb-3">
          <h2 className="fw-bold mb-3">{t("devices.title")}</h2>
          <p className="device-list fw-bold">{t("devices.list")}</p>
        </div>
      </section>
      {/* ===== Reusable Footer ===== */}
      <Footer />
