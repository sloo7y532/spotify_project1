...
import * as i18nRaw from "../i18n.ts";
  ...
  return (
    <>
      ...
      <div className="hero-section">
        ...
        <div className="hero-text">
          ...
          <div className="hero-buttons justify-content-center">
            <button onClick={() => { navigate("/login/*") }} className="start-btn me-4">Get Started</button>
            <button onClick={() => {
              document.getElementById("plans")?.scrollIntoView({ behavior: "smooth" });
            }} className="plans-btn" >See All Plans</button>
          </div>
          <p className="note mt-3">*0 SAR for one month only, then 21.99 SAR/month. Offer available for users who haven’t tried Premium. Terms apply.</p>
        </div>
      </div>
      <section className="">
        <h2 className="fw-bold mb-2 mt-5 text-center ">Feel the Difference</h2>
        <p className="mb-3">
        ...
        <div className="hover-area text-center my-5">
          ...
          {hovered && (
            <div className="image-box mt-3">
              <img src="https://play-lh.googleusercontent.com/aqVjPx-JDaqoD6oyMDmqF24pVko-1p9LAnKyq6k6JycVrMMvXONfAruYfhFHeiJCfwo" alt="StcPay" />
      ...
      <div className="premium-container">
        ...
        <section className="plans-section new-style-plans" id="plans">
          {[
            {
        ...
        {selectedPlan && (
          <div className="payment-form bg-light p-4 rounded my-4">
            <h4 className="mb-3 text-success">Complete Your Payment for: <span className="text-success">{selectedPlan}</span></h4>
            <form onSubmit={(e) => {
              e.preventDefault();
              alert("Payment submitted!");
            }}>
              <div className="mb-3 text-start">
                <label className="form-label text-dark mt-3 mb-0">Full Name</label>
                <input type="text" className="form-control" placeholder="Name on card" required />


                <div className="mb-3">
                  <label className="form-label text-dark mt-3 mb-0">Card Number</label>
                  <input type="text" className="form-control" placeholder="1234 5678 9012 3456" required />
                </div>

                <div className="row">
                  <div className="col-md-6 mb-3">
                    <label className="form-label text-dark mt-3 mb-0">Expiry Date</label>
                    <input type="text" className="form-control" placeholder="MM/YY" required />
                  </div>
                  <div className="col-md-6 mb-3">
                    <label className="form-label text-dark mt-3 mb-0">CVV</label>
