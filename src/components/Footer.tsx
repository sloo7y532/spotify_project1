      ...
      <div className="container">
            ...
            <div className="row">
              <div className="col-6">
                ...
                <ul className="list-unstyled">
                  ...
                  <li><a href="https://apps.microsoft.com/detail/9ncbcszsjrsb?launch=true&mode=mini&cid=spotifyweb-store-button&hl=en-US&gl=SA" className="footer-link">Microsoft Store</a></li>
                </ul>
              </div>
              <div className="col-6">
                ...
                <ul className="list-unstyled">
                  ...
                  <li><Link to="/job" className="footer-link">Jobs</Link></li>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center border-top pt-3 mt-4">
          ...
          <div className="d-flex gap-3 small flex-wrap justify-content-center">
            <a href='https://www.spotify.com/sa-ar/legal/end-user-agreement/'> <span>Legal</span></a>
            <a href='https://www.spotify.com/sa-ar/legal/privacy-policy/'><span>Privacy Center</span></a>
            <a href='https://www.spotify.com/sa-ar/accessibility'><span>Accessibility</span></a>
          </div>
        </div>
      </div>
    </footer>
